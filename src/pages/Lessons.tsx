      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-surface-container-low rounded-lg p-8 hover:bg-surface-container-high transition-colors">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <h3 className="text-xl font-bold">Hiragana Básico</h3>
          </div>
          <p className="text-on-surface-variant mb-6">
            Aprende los caracteres básicos del silabario japonés, la base para leer y escribir.
          </p>
          <button className="bg-primary text-on-primary px-6 py-2 rounded-full font-bold text-sm hover:opacity-90 transition-opacity">
            Comenzar
          </button>
        </div>
